...
suspend fun peuplerRecettesSiVide(db: FirebaseFirestore) {
    ...
    val recettes = listOf(
        Recette(nom = "Pâtes à la tomate", instructions = listOf("Faire cuire les pâtes.", "Faire revenir l'ail dans l'huile, ajouter la sauce tomate, laisser mijoter 10 min.", "Mélanger avec les pâtes, ajouter le parmesan."), tempsPreparationMinutes = 20, portions = 2) to listOf(
        ...
        Recette(nom = "Omelette au fromage", instructions = listOf("Battre les œufs avec sel et poivre.", "Cuire à la poêle avec un peu de beurre.", "Ajouter le fromage râpé, plier en deux."), tempsPreparationMinutes = 10, portions = 1) to listOf(
        ...
        Recette(nom = "Salade de riz", instructions = listOf("Cuire le riz.", "Le laisser refroidir.", "Mélanger avec le thon, les tomates coupées, le maïs et une vinaigrette."), tempsPreparationMinutes = 25, portions = 3) to listOf(
        ...
        Recette(nom = "Poulet rôti aux légumes", instructions = listOf("Assaisonner le poulet.", "Couper les légumes en morceaux.", "Enfourner le tout 45 min à 200°C."), tempsPreparationMinutes = 60, portions = 4) to listOf(
        ...
        Recette(nom = "Soupe de légumes", instructions = listOf("Éplucher et couper les légumes.", "Cuire 30 min dans l'eau.", "Mixer."), tempsPreparationMinutes = 40, portions = 4) to listOf(
            RecetteIngredient(nomIngredient = "carottes", quantiteNecessaire = 300.0, unite = "g"),
        ...
        Recette(nom = "Sandwich au thon", instructions = listOf("Égoutter le thon, mélanger avec la mayonnaise.", "Tartiner le pain, ajouter salade et tomate."), tempsPreparationMinutes = 10, portions = 1) to listOf(
        ...
        Recette(nom = "Riz cantonais", instructions = listOf("Cuire le riz, le laisser refroidir.", "Faire revenir œufs, jambon et petits pois.", "Ajouter le riz, sauce soja."), tempsPreparationMinutes = 25, portions = 3) to listOf(
        ...
        Recette(nom = "Crêpes", instructions = listOf("Mélanger farine, œufs, lait.", "Laisser reposer 30 min.", "Cuire à la poêle."), tempsPreparationMinutes = 45, portions = 6) to listOf(
